...
#define ORTE_QOS_ACK_NACK_TIMEOUT       (ORTE_QOS_START_KEY + 3)         //uint32 - timeout value in ms for msg/window ack nack
#define ORTE_QOS_RETRY                  (ORTE_QOS_START_KEY + 4)         // bool- resend message upon ACK fail or NACK or timeout.

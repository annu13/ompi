...
#endif
ORTE_DECLSPEC void * orte_qos_create_channel (void *qos_mod, opal_list_t *qos_attributes);
 ...
 */
typedef void* (*orte_qos_base_module_create_fn_t) (opal_list_t *qos_attributes);
